...
uri = "mongodb+srv://nan_admin:nan_admin@nanmongodb.smmoxzz.mongodb.net/?retryWrites=true&w=majority&appName=NanMongodb"
...
def get_collection_data(database_name, collection_name, query=None, limit=10, sort=None):
    """
    查看指定集合中的数据
